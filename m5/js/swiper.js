...
(function () {
    ...
    var Swiper = function (container, params) {
        ...
        var defaults = {
            ...
            // NS
            slideClass: 'swipeCont',
            slideActiveClass: 'swipeContOn',
            slideVisibleClass: 'swiper-slide-visible',
            slideDuplicateClass: 'swiper-slide-duplicate',
            slideNextClass: 'swipeContNxt',
            slidePrevClass: 'swipeContPrv',
            wrapperClass: 'swipeArea',
            bulletClass: 'swipeNav',
            bulletActiveClass: 'swipeNavOn',
        ...
        s.classNames.push('swipeWrap-' + s.params.direction);
        ...
        if (s.params.effect !== 'slide') {
            s.classNames.push('swipeWrap-' + s.params.effect);
        }
            ...
            if (s.paginationContainer && s.paginationContainer.length > 0) {
                ...
                for (var i = 0; i < numberOfBullets; i++) {
                    if (s.params.paginationBulletRender) {
                        ...
                        bulletsHTML += '<a href="#none" class="' + s.params.bulletClass + '"></a>';
                    }
                }
        ...
        function handleKeyboard(e) {
            ...
            if (kc === 37 || kc === 39 || kc === 38 || kc === 40) {
                ...
                if (s.container.parents('.swipeCont').length > 0 && s.container.parents('.swipeContOn').length === 0) {
                    return;
                }
                var windowScroll = {
